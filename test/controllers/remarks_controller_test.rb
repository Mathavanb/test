...
class RemarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create remark" do
    assert_difference('Remark.count') do
      post remarks_url, params: { remark: { body: @remark.body, product_id: @remark.product_id } }
    end
  ...
  test "should update remark" do
    patch remark_url(@remark), params: { remark: { body: @remark.body, product_id: @remark.product_id } }
